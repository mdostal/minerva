...
// Method registry — later stories (run-workspace-allocation, kickoff-engine-plumbing,
// question-extraction, escalation-classification, output-emitter, cleanup-ledger-events)
// each add their own method(s) here. Anything not registered falls through to
// UNKNOWN_METHOD, per this story's scope boundary.
